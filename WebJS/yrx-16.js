    ...
    for (var o, a, s, l = 0, c = []; l < e[t(261)];) {
        switch (a = e[t(237)](l),
            ...
            case 0:
                ...
                break;
            case 1:
                // 这个地方是个补环境的坑， 缺失n.g 但是报错信息会被try接收，无法看到缺的参数
                // try {
                    "WhHMm" === i[t(198)] || g && c[t(246)](f[t(245)](i.pHtmC(2 & o, 3) | i.evetF(a, 4)))
                // } catch (e) {
...
console.log(btoa_("1672888987000"))
