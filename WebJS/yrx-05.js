...
//
//
// // _$is = "1673321213452"D:\nodejs\node_global\node_modules
// // _$pr = [
// //     "e025796f43996ac4123f9a0d52199f8f",
// //     "02cdfaf4eac7be436a32a89bfeac7212",
// //     "717588f190cc4072d5e768567bafde7d",
// //     "017f01871fb9d188e4b9a8f081650a15",
// //     "0a7be0eb3a0878b80c924287c50e7f44"
// // ]
// const { JSDOM } = jsdom;
...
_0x4e96b4['$_zw'] = Array(26);
_0x4e96b4['$_zw'][9] = window.eval;
_0x4e96b4['$_zw'][23] = Date.parse(new Date());
var _0xceb4b2 = []
...
//     t = _0x12eaf3();
//     console.log(t)
//     // console.log(_0x4e96b4['_$6_'], _0x4e96b4['_$Jy'], _0x4e96b4['_$tT'])
//     _$pr.push(_0x474032(t))
...
_$pr = [
    "a5491d1eb4134caa92cdd3c1e1381cc1",
    "60c436dbcba923e18901d09ef7be618b",
    "01d101123142415dd6d7f655aa3b42bc",
    "a4f03ad4e57b75701d37675df94445f7"
]
_0x4e96b4['_$6_'] = -389564586;
_0x4e96b4['_$Jy'] = -405537848;
_0x4e96b4['_$tT'] = -660478335;
st = _0x2d5f5b().toString();
_0x4e96b4['_$is'] = st;
_$pr.push(_0x474032(st))
...
function getArgs(){
    let params_m = window._$is;
    let params_f = window.$_zw[23].toString();
    let cookie_m = _$pr[_$pr.length-1];
    let cookie_RM4hZBv0dDon443M = _0x4e96b4['_$ss'];
    return [params_m, params_f, cookie_m, cookie_RM4hZBv0dDon443M]
}
